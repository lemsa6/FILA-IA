...
@section('title', 'Criar Nova Chave de API')
                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('admin.apikeys.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="rate_limit_minute" id="rate_limit_minute" value="{{ old('rate_limit_minute', 60) }}" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="rate_limit_hour" id="rate_limit_hour" value="{{ old('rate_limit_hour', 1000) }}" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="rate_limit_day" id="rate_limit_day" value="{{ old('rate_limit_day', 10000) }}" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
